...
export const taxonomyCases = [
  {
    path: "/dashboard/alliance?tab=regions",
    heading: "Regions",
  ...
  {
    path: "/dashboard/alliance?tab=group-categories",
  ...
  {
    path: "/dashboard/alliance?tab=event-categories",
...
export const ensureAllianceGroupsManagerRole = async (role, page) => {
