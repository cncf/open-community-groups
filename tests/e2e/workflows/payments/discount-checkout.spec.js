...
import { TEST_COMMUNITY_NAME, TEST_GROUP_SLUGS, TEST_TICKETING_EVENTS } from "../../seed.js";
...
import { openEventUpdateFormByName, openPaymentsSection } from "../../dashboard/group/events/helpers.js";
...
test.describe("paid event discount checkout workflow", () => {
  test("a full discount completes paid question checkout for free", async ({
    ...
    try {
      ...
      await registrationModal.getByRole("textbox").fill("Please prepare accessible workshop materials.");
      ...
      expect(answers.answers?.[0]?.value).toBe("Please prepare accessible workshop materials.");
