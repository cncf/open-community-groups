...
From [Explore](/explore ':ignore'), start with `Events` to see what is
...
![Explore events list view](../screenshots/explore-events-list.png)

![Explore events calendar view](../screenshots/explore-events-calendar.png)
...
review controls, see [Event Operations](../guides/event-operations.md).
...
![User menu and dashboard options](../screenshots/navigation-user-menu.png)
