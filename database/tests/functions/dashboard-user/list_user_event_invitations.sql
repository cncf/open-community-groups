...
\set allianceID '4a0b0000-0000-0000-0000-000000000003'
...
insert into alliance (
    ...
    :'allianceID',
    'event-invitations-alliance',
    'Event Invitations Alliance',
    'Alliance for testing event invitation listings',
...
values
    (:'groupID', :'allianceID', :'groupCategoryID', 'Event Invitations Group', 'events', true),
    (:'inactiveGroupID', :'allianceID', :'groupCategoryID', 'Inactive Group', 'inactive', false);
...
select is(
    ...
    format(
        $json$
            [
                {
                    "alliance_display_name": "Event Invitations Alliance",
                    "alliance_name": "event-invitations-alliance",
                    "event_id": "%s",
