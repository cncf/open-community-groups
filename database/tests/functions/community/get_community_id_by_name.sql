...
insert into community (
    ...
    (:'community1ID', 'test-community', 'Test Community', 'A test community', 'https://example.com/logo.png'),
    (:'community2ID', 'inactive-community', 'Inactive Community', 'An inactive community', 'https://example.com/logo2.png');
