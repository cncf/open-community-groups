...
values
    (:'user1ID', 'organizer1@example.com', :'community1ID', 'Alice', 'Johnson', 'https://example.com/alice.png', 'Cloud Co', 'Manager', 'https://facebook.com/alice', 'https://linkedin.com/in/alice', 'https://twitter.com/alice', 'https://alice.com'),
    (:'user2ID', 'organizer2@example.com', :'community1ID', 'Bob', 'Wilson', 'https://example.com/bob.png', 'StartUp', 'Engineer', null, 'https://linkedin.com/in/bob', null, 'https://bob.com'),
    (:'user3ID', 'member1@example.com', :'community1ID', 'Charlie', 'Brown', null, null, null, null, null, null, null),
    (:'user4ID', 'member2@example.com', :'community1ID', 'Diana', 'Prince', null, null, null, null, null, null, null);
