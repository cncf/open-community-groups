...
-- Event: needs meeting create (meeting_requested=true, meeting_in_sync=false, no meeting row)
insert into event (
    event_id,
    group_id,
    name,
...
-- Event: needs meeting update (meeting_requested=true, meeting_in_sync=false, has meeting row)
insert into event (
    event_id,
    group_id,
    name,
...
insert into meeting (meeting_id, event_id, provider_meeting_id, url, password)
...
insert into meeting (meeting_id, event_id, provider_meeting_id, url)
...
insert into meeting (meeting_id, session_id, provider_meeting_id, url, password)
...
insert into meeting (meeting_id, session_id, provider_meeting_id, url)
...
-- Event: needs meeting create with password required (meeting_requires_password=true)
...
select is(
    ...
    '{
        ...
        "timezone": null,
        "topic": null,
        "url": "https://zoom.us/j/777888999"
    }'::jsonb,
    'Session needing delete (parent canceled) returns correctly'
);

-- Remove session meeting to test next case
