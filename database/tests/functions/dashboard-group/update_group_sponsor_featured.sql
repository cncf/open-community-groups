...
\set allianceID '30000000-0000-0000-0000-000000000001'
...
values (:'allianceID', 'cloud-native-paris', 'Cloud Native Paris', 'Alliance for cloud native technologies in Paris', 'https://example.com/logo.png', 'https://example.com/banner_mobile.png', 'https://example.com/banner.png');

-- Group Category (required by group)
insert into group_category (group_category_id, name, alliance_id)
values ('30000000-0000-0000-0000-000000000011', 'Tech', :'allianceID');

-- Group
insert into "group" (group_id, alliance_id, name, slug, group_category_id)
values (:'groupID', :'allianceID', 'Group Paris', 'group-paris', '30000000-0000-0000-0000-000000000011');
