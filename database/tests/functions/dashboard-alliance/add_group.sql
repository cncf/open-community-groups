...
insert into "group" (group_id, alliance_id, group_category_id, name, slug, slug_pretty)
values (:'groupPrettySlugID', :'allianceID', :'categoryID', 'Pretty Slug Collision Group', 'existing-slug', 'abc2345');
