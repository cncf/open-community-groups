...
values (:'allianceID', 'attendee-state-alliance', 'Attendee State Alliance', 'Test', 'https://e/logo.png', 'https://e/banner-mobile.png', 'https://e/banner.png');
...
values (:'groupID', :'allianceID', :'groupCategoryID', 'Attendee State Group', 'attendee-state-group');
