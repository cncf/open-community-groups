...
values
    (:'group1ID', 'G1', 'g1', :'allianceID', :'categoryID', true, false),
...
values (:'eventCategoryID', 'Cat', :'allianceID');
...
-- Should return correct alliance statistics as JSON
select is(
    get_alliance_site_stats('00000000-0000-0000-0000-000000000001'::uuid)::jsonb,
    '{
        "events": 1,
        "groups": 2,
        "groups_members": 3,
...
select is(
    get_alliance_site_stats('00000000-0000-0000-0000-999999999999'::uuid)::jsonb,
    '{
        "events": 0,
        "groups": 0,
        "groups_members": 0,
