...
values (:'category1ID', 'Technology', :'allianceID');
...
values (:'eventCategory1ID', 'Tech Talks', :'allianceID');
...
select is(
    get_alliance_upcoming_events('00000000-0000-0000-0000-000000000001'::uuid, array['in-person', 'virtual', 'hybrid'])::jsonb,
    jsonb_build_array(
...
select is(
    get_alliance_upcoming_events('00000000-0000-0000-0000-999999999999'::uuid, array['in-person', 'virtual', 'hybrid'])::jsonb,
    '[]'::jsonb,
    'Should return empty array for non-existing alliance'
);
