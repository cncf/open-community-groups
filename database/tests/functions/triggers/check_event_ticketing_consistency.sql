...
insert into community (
    ...
    :'communityID',
    'ticketing-shape-community',
    'Ticketing Shape Community',
    'Community for ticketing consistency trigger tests',
...
values (:'groupID', :'communityID', :'groupCategoryID', 'Ticketing Shape Group', 'ticketing-shape-group');
