-- delete_event_series_events atomically soft-deletes events from the same series.
create or replace function delete_event_series_events(
...
begin
    ...
    loop
        perform delete_event(p_actor_user_id, p_group_id, v_event_id);
    end loop;
end;
$$ language plpgsql;
