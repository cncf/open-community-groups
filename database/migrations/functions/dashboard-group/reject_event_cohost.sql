...
create or replace function reject_event_cohost(
...
begin
    ...
    update event_cohost
    set
        event_cohost_status_id = 'rejected',
    ...
    -- Audit the rejected transition for both groups
    perform insert_event_cohost_audit(
        'event_cohost_rejected',
        p_actor_user_id,
        v_event.event_id,
        v_event.group_id,
        p_cohost_group_id,
