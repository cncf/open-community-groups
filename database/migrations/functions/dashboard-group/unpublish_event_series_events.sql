-- unpublish_event_series_events atomically unpublishes events from the same series.
create or replace function unpublish_event_series_events(
...
begin
    ...
    loop
        perform unpublish_event(p_actor_user_id, p_group_id, v_event_id);
    end loop;
end;
$$ language plpgsql;
