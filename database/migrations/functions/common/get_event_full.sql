...
returns json as $$
    ...
    select jsonb_strip_nulls(
        ...
        || jsonb_build_object(
            ...
            'registration_ends_at', epoch_seconds(e.registration_ends_at),
            'registration_starts_at', epoch_seconds(e.registration_starts_at),
