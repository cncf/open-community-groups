...
returns json as $$
    select json_strip_nulls(json_build_object(
        ...
        'meeting_url', coalesce(m_event.url, e.meeting_url),
        'meetup_url', e.meetup_url,
        'photos_urls', e.photos_urls,
        'published_at', floor(extract(epoch from e.published_at)),
        'recording_url', coalesce(m_event.recording_url, e.recording_url),
            ...
            event_sessions as (
                select
                    ...
                    json_strip_nulls(json_build_object(
                        ...
                        'meeting_url', coalesce(m_session.url, s.meeting_url),
                        'recording_url', coalesce(m_session.recording_url, s.recording_url),
