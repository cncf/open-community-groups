-- Returns paginated audit log rows for the alliance dashboard.
create or replace function list_alliance_audit_logs(p_alliance_id uuid, p_filters jsonb)
returns json as $$
    with
        ...
        filtered_logs as (
            ...
            where al.alliance_id = p_alliance_id
