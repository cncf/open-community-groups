...
{{ template "dashboard-admin/add_group.sql" }}
{{ template "dashboard-admin/delete_group.sql" }}
{{ template "dashboard-admin/list_community_groups.sql" }}
{{ template "dashboard-admin/list_group_categories.sql" }}
{{ template "dashboard-admin/list_regions.sql" }}
{{ template "dashboard-admin/update_group.sql" }}
