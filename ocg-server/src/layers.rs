...
const DB_OPERATION_TYPES: &[&str] = &[
    ...
    "db::dashboard::group::EventCohostNotificationData",
    "db::dashboard::group::EventCohostRef",
    "db::dashboard::group::EventCohostResponse",
    "db::dashboard::group::EventCohostsSync",
