...
const ALLIANCE_ANALYTICS_DATA_SELECTOR = "[data-alliance-analytics]";
const ALLIANCE_ANALYTICS_READY_KEY = "allianceAnalyticsReady";
...
const initPageViewsCharts = async (pageViews = {}, palette) => {
  ...
  return [
    ...
    {
      elementId: "alliance-views-monthly-chart",
      title: "Monthly alliance page views",
      description: "Alliance page views grouped by month",
      path: ["alliance", "per_month_views"],
      kind: "monthly",
    },
    {
      elementId: "alliance-views-daily-chart",
      title: "Daily alliance page views during the last month",
      description: "Alliance page views over the last 30 days",
      path: ["alliance", "per_day_views"],
      kind: "daily",
    },
    {
 ...
 * @param {Object} stats - Alliance analytics payload.
 * @param {Object} palette - Theme palette.
 */
 ...
 * @param {Object} stats - Alliance statistics payload from the server.
 */
...
/**
 * Initialize alliance analytics charts from the page JSON marker.
 ...
 */
export const initializeAllianceAnalyticsFromPage = async (root = document, context = {}) => {
  return initializeChartsFromJsonMarker({
    root,
    selector: ALLIANCE_ANALYTICS_DATA_SELECTOR,
    readyKey: ALLIANCE_ANALYTICS_READY_KEY,
    initialize: initAnalyticsCharts,
    parseErrorMessage: "Failed to parse alliance analytics payload:",
    initErrorMessage: "Failed to initialize analytics charts:",
    force: context.historyRestore === true,
  });
};

initializeOnReadyAndHtmxLoad(initializeAllianceAnalyticsFromPage);
