import { searchOnEnter } from "/static/js/alliance/explore/filters.js";
...
/**
 * Initializes search input behavior for the alliance groups list.
...
/**
 * Initializes action dropdown behavior for alliance group rows.
 * @param {Document|Element} root - Root element to search from.
 * @returns {void}
 */
...
/**
 * Initializes alliance groups list behavior for the current content root.
 * @param {Document|Element} root - Root element to search from.
 * @returns {void}
 */
export const initializeAllianceGroupsList = (root = document) => {
  initializeGroupsSearch(root);
  initializeGroupSelection(root);
  initializeGroupActionMenus(root);
};

initializeOnReadyAndHtmxLoad(initializeAllianceGroupsList);
