...
import "/static/js/dashboard/user/session-proposals/modal.js";
...
const initializeSessionProposals = (root = document) => {
  // HTMX can swap buttons and modal as siblings, so fall back to the document.
  ...
  if (modalComponent) {
    // The table stores JSON payloads; enrich them with trusted sibling HTML.
