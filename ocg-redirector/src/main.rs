//! Open Alliance Groups redirector.
//!
//! This service handles permanent redirects from alliance-specific legacy URLs
//! to their canonical pages in Open Alliance Groups.
